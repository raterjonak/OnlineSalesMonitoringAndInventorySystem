...
body{background-image:url('image/In-Blue-Only-Yet-There-Really-Are-Changes-You-Won-t-Ever-be-Bored-in-Vision-HD-Single-Color-Wallpaper.jpg');}
img{
float:right;
margin:10px;
width:370px;
...
<table border=0pt cellpadding='15pt'  >
	  ...
	  <tr>
	   ...
	   <tr>
	       <td><?php echo $productid3; ?></td> <td><?php echo $quantity3;?></td> <td><?php echo  $rate3;?></td> <td><?php echo  $price3;?></td>
	  </tr>
	   <tr>
...
<p2><b>Total Price:</b><?php echo  $totalprice1." ";?>TK.</p2>	 <br> <br> 
<?php
