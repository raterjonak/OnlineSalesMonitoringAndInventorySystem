...
p{text-align:center;}p2{margin:210px;}p3{font-size:25px;}p4{margin:700px;}a{font-size:16px;color:black;margin:230px;}p5{margin:260px}
</style>
</head>
<body>
<div class='ex'>
...
<p2><b>Total Price:</b><?php echo  $price1." ";?>TK.</p2>	 <br>  <br> 
<?php
